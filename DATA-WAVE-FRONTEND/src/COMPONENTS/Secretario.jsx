...
const Secretario = () => {
  ...
  const buttonClass =
    "bg-sky-800 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline text-center block w-full mb-3 h-12"; 
  const buttonClassCierre =
    "bg-green-300 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline text-center block w-full mb-3 h-12"; 
    const buttonClassCancelar =
    "bg-red-300 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline text-center block w-full mb-3 h-12"; 
    ...
    return (
      ...
      <div className="flex-none w-1/5 bg-gray-800 p-4 flex flex-col items-center justify-start h-screen">
        ...
        {reportesMenuOpen && (
          <div className="bg-sky-800 text-white font-bold rounded focus:outline-none focus:shadow-outline text-center block w-full mb-3">
            <Link to="/instituto/lista/" className="block px-4 py-2 text-sm hover:bg-gray-700">
              LISTADO DE INSTITUTOS
            </Link>
            <Link to="/inspector/editar-instituto" className="block px-4 py-2 text-sm hover:bg-gray-700">
...
{showLogoutConfirm && (
  <div className=" text-white font-bold rounded focus:outline-none focus:shadow-outline text-center block w-full mb-3">
    <button className={`${buttonClassCierre} block px-4 py-2 text-sm hover:bg-gray-700 mb-1`} onClick={logout}>
      CONFIRMAR
    </button>
    <button className={`${buttonClassCancelar} block px-4 py-2 text-sm hover:bg-gray-700`} onClick={cancelLogout}>
      CANCELAR
    </button>
  </div>
)}
      ...
      >
        {showWelcomeMessage && (
          <div className="flex flex-col justify-center items-center h-full">
            ...
            />
            <p className="font-arial text-4xl font-bold text-blue-800 mb-5 transition-opacity duration-4000 ease-in-out opacity-100">
