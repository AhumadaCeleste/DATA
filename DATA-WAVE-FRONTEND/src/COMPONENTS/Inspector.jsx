      ...
      <div className="flex flex-1">
        ...
        <div className="flex-none w-1/4 bg-gray-800 p-2 rounded-r-3 flex flex-col justify-center items-center">
          <button
            ...
            className="bg-sky-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-2 text-center block w-full"
          >
            INSTITUTOS
          </button>
          {institutosMenuOpen && (
            <div className="bg-sky-600 text-white font-bold rounded focus:outline-none focus:shadow-outline mb-2 text-center block w-full">
          ...
          <button
            className="bg-sky-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline text-center block w-full"
            type="button"
          >
            CERRAR SESION
          </button>
