...
function CreateDepto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("http://localhost:3001/departamento/nuevo", nuevoDepartamento);
      console.log(res);
  ...
  return (
    <div className="bg-primary py-16 px-16 rounded-md w-auto m-8">
      <div className="contactar-container">
        <h2 className="titulo_pricipal_paginas mb-4 mt-0 shadow-lg text-center">Crear Departamento de producto</h2>
